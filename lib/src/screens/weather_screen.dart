...
enum OptionsMenu { kualaLumpur, georgeTown, johorBahru, changeCity, settings }
...
class _WeatherScreenState extends State<WeatherScreen>
            ...
            PopupMenuButton<OptionsMenu>(
                ...
                itemBuilder: (context) => <PopupMenuEntry<OptionsMenu>>[
                      PopupMenuItem<OptionsMenu>(
                        value: OptionsMenu.kualaLumpur,
                        child: Text("Kuala Lumpur"),
                      ),
                      PopupMenuItem<OptionsMenu>(
                        value: OptionsMenu.georgeTown,
                        child: Text("George Town"),
                      ),
                      PopupMenuItem<OptionsMenu>(
                        value: OptionsMenu.johorBahru,
  ...
  _onOptionMenuItemSelected(OptionsMenu item) {
    switch (item) {
      case OptionsMenu.kualaLumpur:
        _cityName = "Kuala Lumpur";
        this._fetchWeatherWithCity();
        break;
      case OptionsMenu.georgeTown:
        _cityName = "George Town";
        this._fetchWeatherWithCity();
        break;
      case OptionsMenu.johorBahru:
        _cityName = "Johor Bahru";
        this._fetchWeatherWithCity();
        break;
